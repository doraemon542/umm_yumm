...
const TopNav = () => {
  ...
  return (
    <div className='max-w-[1900px] mx-auto flex justify-between items-center p-4'>
       <div className='flex items-center'>
          <div onClick={() => setSideNav( !sideNav )} className='cursor-pointer'>
            <AiOutlineMenu size={25}/>
          </div>
          <h1 className='text-2xl sm:text-3xl lg:text-4xl px-2'>
            Umm<span className='font-bold'>Yumm</span>
          </h1>
       ...
       <div className='bg-gray-200 rounded-full flex items-center px-2 w-[200px] sm:w-[400px] lg:w-[500px]'>
        ...
        <input className='bg-transparent p-2 w-full focus:outline-none'type='text'placeholder='Search yum yum' />
       ...
       <button className='bg-orange-700 text-white hidden md:flex items-center py-2 rounded-full'>
        ...
        <div className={
            ...
            <h2 className='text-2xl p-4'>Umm<span className='text-orange-700 font-bold'>Yumm</span></h2>
            <nav>
